...
public class OperatorUserSearch extends JFrame implements ActionListener
{
		...
		if(e.getSource() == submit)
		{
			...
			String n = t1.getText().trim();
		     ...
		     if ( matched == null )
		     {
		    	 ...
		    	 JOptionPane.showMessageDialog(this, "INVALID 	OPERATOR NAME\nIt should contain only digit.", "Error", JOptionPane.ERROR_MESSAGE);
		         t1.setText("");
		     }
		     else
		     {
